...
<div>
  ...
  <div class='fieldset'>
    ...
    <form action="Registertest.jsp" method="post" class="parsley">
      <div class='row'>
...
<select name="typ">
      ...
      <div class='row'>
        <label for="email">  Write Question<br></label>
<input type="text" name="question" value="" />      </div>
         Option 1 :<input type="text" name="option1" value="" required=""/><br>
         Option 2 :<input type="text" name="option2" value="" required=""/><br>
          Option 3 :<input type="text" name="option3" value="" required=""/><br>
           Option 4 :<input type="text" name="option4" value="" required=""/><br>
           Answer :<br><input type="text" name="answer" value="" required=""/>
     ...
     <footer>
    <div style="position: absolute;overflow: hidden; left: 500px; top:1200px;width:500px; height:40px;  z-index: 2" class=" c">
