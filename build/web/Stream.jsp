...
<div>
  ...
  <div class='fieldset'>
    <legend>Main Stream Details</legend>
    <form action="Registerstream.jsp" method="post" data-validate="parsley">
      <div class='row'>
        <label for='firstname'>College Name</label>
        <input type="text" placeholder="College Name" name='College' id='firstname' data-required="true" data-error-message="Your First Name is required">
      </div>
      <div class='row'>
        <label for="email">Stream Name</label>
        <input type="text" placeholder="Stream"  name='Stream' data-required="true" data-type="email" data-error-message="Your E-mail is required">
      </div>
         <div class='row'>
        <label for="email">Main Stream</label>
      ...
      <div class='row'>
        <label for="cemail">Features</label>
       
        <input type="text" placeholder="Features" name='Features' data-required="true" data-error-message="Your E-mail must correspond">
      </div>
     ...
     <footer>
    <div style="position: absolute;overflow: hidden; left: 500px; top:850px;width:500px; height:70px;  z-index: 2" class=" c">
        Made By Sakshi Dongar
    </div>
</footer>
    </center>
    </body>
