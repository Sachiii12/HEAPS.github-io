...
<div>
        ...
        <%
            try
            {
              ...
              String sql="select * from college_cutoff";
            ...
            <table border="1">
                    ...
                    <thead>
                        <tr>
                            <th class="ws1">Main Stream</th>
                            <th class="ws1">Stream Name</th>
                            <th class="ws1">College Name</th>
                            <th class="ws1"> College Cutoff</th>
                ...
                <tbody>
                    ...
                    <%
                        while(rs.next())
                        {
                            %>
                            <tr>
                                <td class="ws1"><%=rs.getString("Main_Stream")%></td>
                                <td class="ws1"><%=rs.getString("Stream")%></td>
                                <td class="ws1"><%=rs.getString("College")%></td>
                                <td class="ws1"><%=rs.getString("Cutoff")%></td>
